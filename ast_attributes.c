...
/*
    Set a symbol attribute. The symbol is stored as a whole unit with the
    dots.
*/
...
/*
    Set a zero data flag from the enums in the header. The presence or
    absence of a flag indicates the information.
*/
...
/*
    Set a value attribute. A pointer to the value is passed as well as
    the type. Both are stored separately in the attribute store.
*/
...
/*
    Get the value. This function expects the caller to get the type of the
    value and cast it to the proper type.
*/
