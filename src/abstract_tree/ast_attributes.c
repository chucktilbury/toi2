...
convert_to_string (attrib_type_t type)
{
 ...
 */
void
ast_set_flag (attrib_type_t type)
{
 ...
 */
int
ast_get_flag (attrib_type_t type)
{
 ...
 */
void
ast_set_value (void *value, attrib_type_t type)
{
 ...
 */
void *
ast_get_value (attrib_type_t * type)
{
